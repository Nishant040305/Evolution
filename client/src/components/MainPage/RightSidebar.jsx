...
const RightSidebar = ({ closeSidebar, id }) => {
  ...
  document.addEventListener('mousedown', function(e) {
    ...
    const target = e.target.closest('.resizable-right, .resizable-left, .resizable-left-right');
    if (!target) return;

    // Determine the direction of resizing
    const isResizingRight = target.classList.contains('resizable-right') || target.classList.contains('resizable-left-right');
    const isResizingLeft = target.classList.contains('resizable-left') || target.classList.contains('resizable-left-right');
